  ...
  return (
    <footer className="site-footer">
        ...
        <div className="footer-grid">
          <div className="footer-col footer-brand">
            ...
            <div className="footer-social">
              ...
              <a href="https://www.facebook.com/emma.delao/" aria-label="Facebook" target="_blank" rel="noopener noreferrer">
      ...
      <div className="footer-bottom">
        <div className="container">
          <p>&copy; 2026 Solo Buenas Noticias. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  )
